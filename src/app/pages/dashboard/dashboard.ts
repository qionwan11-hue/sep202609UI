...
import { AccountBalanceHeader } from './components/account-balance-header/account-balance-header';

@Component({
    selector: 'app-dashboard',
    imports: [ RecentSalesWidget, NotificationsWidget,AccountBalanceHeader],
